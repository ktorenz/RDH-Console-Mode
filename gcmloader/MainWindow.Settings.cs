...
namespace gcmloader
{
    public sealed partial class MainWindow : Window
    {
        ...
        {
            // RDH patch: the v2.6.8 tag forces launcher = "steam" from EIGHT call
            // sites (settings overlay init, boot launcher path, and others), which
            // silently reverts a hand-configured launcher = "playnite". Preserve
            // the Playnite selection; behave exactly as before otherwise.
